...
你已決定 **會買自己嘅域名**。預算上當每月約 US$1 計；**1 個 Pro 已經夠填域名**。功能 9 你負責買名／轉 DNS，我負責接到網站同只改 Pro 會員中心嗰條 `--app=` 網址。

---

## E. 15 日試用、拒付係咩、同 $2.99 市場合較

### E1. Stripe／Clerk 支唔支援 15 日試用？

**支援。** 兩間都可以做「先用 Pro 15 日，到期先扣 $2.99」。唔使另外搵第三間公司。

| | 可唔可以 15 日 | 客人會見到咩 | 要注意 |
| --- | --- | --- | --- |
| **Stripe** | 可以。訂閱可設試用日數（最長兩年，15 日完全得） | 結帳頁會寫「試用期完結先扣款」 | 預設多數要先綁信用卡，15 日後自動扣；取消就唔扣 |
| **Clerk Billing** | 可以。後台打開 Free trial，填日數（最少 1 日，可填 15） | 同樣先用 Pro，到期先收錢 | 每個客人 **只能試一次**；預設都要綁卡。可改成唔綁卡，但到期就 **唔會自動轉付費**，要客人自己再訂 |

同而家畫面點接：免費方案已經永久 $0（TXT、2 張背景）。15 日試用係俾人試 **Pro**（EPUB、彈出視窗、Panic、之後雲端進度），唔係再送一個免費方案。`payment.html`「確認付款」可以改成「開始 15 日試用」，成功後入 Pro 會員中心；到期未取消先至扣 $2.99。

**興趣項目建議（等你揀）：**

- **想減少濫用：** 試用要綁信用卡（Stripe 預設）。否則有人用完 15 日再換電郵再試。
- **你已經有永久免費版：** 試用唔係必須。好多客人可以免費用完先決定升 Pro。
- **香港卡要注意：** Clerk Billing **而家唔支援 3D 驗證（3DS）**。香港好多信用卡網上付款要過銀行短信／App 確認。試用完自動扣款時客人不在場，呢類卡可能扣唔到。若客人主要喺香港，**Pro 收錢較穩陣係用 Stripe 自己嘅結帳頁**，而唔係經 Clerk Billing 包一層。15 日試用仍然可以喺 Stripe 開。

### E2. 「拒付一次香港約 HK$85」係咩意思？

唔係你主動罰客人，亦唔係每月固定月費。

用日常例子：客人用信用卡訂咗 Pro。之後佢去 **銀行／信用卡公司** 話「呢筆我唔認得／我冇授權」（有時係真盜用，有時係用完想反口、唔記得係自動續訂）。銀行就會同 Stripe 抽走嗰筆錢，呢個就叫 **拒付／爭議交易**（chargeback）。

香港 Stripe 公開價：

1. 銀行一開爭議，Stripe 即刻從你帳戶扣走 **嗰個月 Pro 金額**，再加一筆 **HK$85「收到爭議」手續費**。
2. 呢筆 HK$85，多數情況 **贏輸都唔退**（唔係香港你特登貴，而係卡組織規則）。
3. 若你唔服、提交證據反駁，再加一筆 HK$85；你贏咗先退返呢第二筆。過程可以去到幾個月。
4. 爭議太多，Stripe／卡組織可能當高風險，嚴重可以停收款。

**點解同 $2.99 有關：** 一次拒付 ≈ 損失 **HK$85 + 嗰個月 Pro 實收**。HK$85 已經大約係 **三至四個月** $2.99 嘅實收。所以唔係嚇你唔好做生意，而係細額月費承受唔起「用完就去銀行鬧」嘅人。減少方法：結帳寫清楚自動續訂、易取消（會員中心「管理訂閱」）、電郵收據、免費版已經可用所以唔好誇大 Pro。

普通退款（客人喺網站取消、你喺 Stripe 撳退款）**唔係**拒付，通常無 HK$85。

### E3. US$2.99 喺市面平定貴？有冇類似應用？

未發現第二個 **同樣偽裝成 Chrome 工具列、無須安裝嘅 SaaS** 公開賣月費。接近嘅「辦公室隱蔽閱讀」多數係 **免費網頁／開源**，普通電子書 App 就貴好多，但用途唔一樣。

**最接近：辦公室偽裝閱讀（直接對手）**

| 產品 | 偽裝成咩 | 收費 |
| --- | --- | --- |
| **SneakRead**（sneakread.com） | Word／VS Code／飛書等成個畫面 | **全免費**、開源、唔使帳戶 |
| **ReadCover** | Word 界面 + 老闆鍵 | **免費網頁**（有推 PWA，同你「無須安裝」路線不同） |
| **Demoyu 等開源摸魚閱讀器** | VS Code／Word | **免費** |
| **Stealth Reader（你）** | Chrome 工具列；句子喺偽裝網址列 | 免費 TXT；$2.99／月 Pro |

呢類客人嘅「市價」其實係 **$0**。$2.99 唔係貴過 Kindle，而係 **貴過免費摸魚工具**。競爭力唔喺價錢戰，而喺你獨有嘅 Chrome 工具列偽裝、無須安裝、誠實講原生網址列、以及 Pro 嘅 EPUB／Panic／彈出視窗。免費版一定要夠用，否則客人會去 SneakRead。

**普通閱讀器／書庫（用途唔同，只作價錢感覺）**

| 產品 | 大約價錢 | 買嘅係咩 |
| --- | --- | --- |
| Moon+ Reader Pro | 一次過約 US$12 | 手機電子書 App |
| ReadEra Premium | 一次過約 US$15 | 手機電子書 App |
| Kindle Unlimited | 約 **US$11.99／月** | 海量書庫，唔係隱蔽閱讀 |
| ElevenReader Ultra | 約 US$11／月 | 聽書 |
| 蘋果／Google 常見「解鎖 Pro」 | **US$2.99／月** 好常見 | 細功能訂閱心理價 |

**判斷（前端／產品角度）：**

- **唔算貴：** 比起 Kindle Unlimited（約 $12／月）或者一次過 $12 嘅閱讀 App，每月 $2.99（約一杯平價咖啡以下）好平。心理上係「衝動價」，唔會覺得係奢侈品。
- **相對免費對手，唔算平：** 想「辦公室隱蔽睇書」嘅人，而家好多 $0 替代。$2.99 要靠 **免費版已經好用**，Pro 先賣 EPUB、彈窗、Panic、之後雲端進度。
- **競爭性：** 你唔係同 Kindle 搶書庫，而係同免費偽裝工具搶「上班可唔可以安心睇」。$2.99 有競爭力嘅前提係 Chrome 工具列呢個賣點真係啱你目標客人；若佢哋其實想要 Word／VS Code 皮，會揀免費 SneakRead。
- **太貴？** 對「只想摸魚、有免費就得」嘅人，任何月費都貴。對「想要 EPUB＋Panic＋會員進度」嘅人，$2.99 偏低而唔係偏高。
- **太平？** 對回本同拒付風險略平（見第 D、E2 節）；對市場觀感仍然合理。若之後覺得手續費煩，先考慮 $4.99，唔使跳去 $9.99 先同 Kindle 比較。

**建議（仍等你決定）：** 維持 **Free $0 + Pro US$2.99** 喺市場上站得住。15 日 Pro 試用係加分，唔係必須。免費版就當永久試用入門；Pro 試用只為解開付費功能。
...
8. **預算：** 興趣項目用各平台免費計劃；Pro 標價暫留 $2.99 或改為你指定嘅新價（見第 D 節）
